						...
						<form action="${pageContext.request.contextPath}/Login"
							...
							<div class="form-group">
								<label for="your_name"><i
									...
									type="text" name="Name" id="your_name" placeholder="User Name" />
							</div>
							<div class="form-group">
								<label for="your_pass" class="password-label"><i
  ...
  gtag('config', 'UA-23581568-13');
    ...
    function togglePassword() {
        ...
        if (passwordInput.type === "password") {
            ...
            passwordLabel.innerHTML = '<i class="zmdi zmdi-unlock"></i>';
        } else {
            passwordInput.type = "password";
            passwordLabel.innerHTML = '<i class="zmdi zmdi-lock"></i>';
        }
    }

    // Add a click event listener to the label
    document.querySelector(".password-label").addEventListener("click", togglePassword);
</script>
