...
<body>
	...
	<header class="header" id="header">
		<nav class="nav container">
			<a href="" class="nav__logo"> <i class="ri-steering-fill"></i>
				NextCar
			</a>
			<div class="nav__menu" id="nav-menu">
				<ul class="nav__list">
					...
					<li class="nav__item"><a href="#popular" class="nav__link">Super
							Cars</a></li>
					...
					%>
					<li class="nav__item"><a href="/ShowRoomCar/SuperCarWebsite-main/SuperCarWebsite-main/index.jsp" class="nav__link">Logout</a></li>
				</ul>
			...
			<div class="featured__container container">
				...
				<div class="featured__content grid">
					...
					<article class="featured__card mix tesla">
						...
						<img
							src="/ShowRoomCar/SuperCarWebsite-main/SuperCarWebsite-main/assets/img/featured1.png"
					...
					<article class="featured__card mix tesla">
						...
						<img
							src="/ShowRoomCar/SuperCarWebsite-main/SuperCarWebsite-main/assets/img/featured2.png"
							alt="" class="featured__img">
					...
					<article class="featured__card mix audi">
						...
						<img
							src="/ShowRoomCar/SuperCarWebsite-main/SuperCarWebsite-main/assets/img/featured3.png"
							alt="" class="featured__img">
					...
					<article class="featured__card mix porsche">
						...
						<img
							src="/ShowRoomCar/SuperCarWebsite-main/SuperCarWebsite-main/assets/img/featured4.png"
							alt="" class="featured__img">
					...
					<article class="featured__card mix porsche">
						...
						<img
							src="/ShowRoomCar/SuperCarWebsite-main/SuperCarWebsite-main/assets/img/featured5.png"
							alt="" class="featured__img">
						<h3 class="featured__price">$175,900</h3>
						<button class="button featured__button">
							<i class="ri-shopping-bag-2-line"></i>
